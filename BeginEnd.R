...
# system("rm seawaveQ_0.8.1.tar.gz")
clear_caches()
package.skeleton(name = "seawaveQ", force = TRUE,
                 code_files = c("rosBoxPlot.R", "combineData.R", 
                              ...
                              "prepData.R", "fitMod.R", "fitMod2.R",
                              "seawaveQPlots2.R", "cenScatPlot.R"))
roxygenize(package.dir = "seawaveQ", clean = TRUE)
...
system("R CMD check --as-cran seawaveQ_2.0.0.tar.gz")

remove.packages("seawaveQ")
install.packages("seawaveQ_2.0.0.tar.gz",repos = NULL, type = "source")
library(seawaveQ)
