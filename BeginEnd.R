...
system("rm seawaveQ_0.7.0.tar.gz")
clear_caches()
...
system("cp ./vignette/vignette.pdf ./seawaveQ/inst/doc/.")
...
system("R CMD check --as-cran seawaveQ_0.7.0.tar.gz")
# system("R CMD check seawaveQ_0.5.0.tar.gz")

remove.packages("seawaveQ")
install.packages("seawaveQ_0.7.0.tar.gz",repos=NULL,type="source")
library(seawaveQ)
