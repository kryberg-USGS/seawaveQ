...
#' variables
#' @param qwdat The dataset containing water-quality sample data with 
...
#' @param qwcols A character vector with column headings for 
...
#' @param cqwdat The dataset containing variables that can be used as 
